                        ...
                        <Grid item className={classes.grow}>
                            ...
                            {isAuth &&
                                <div className="dropdown" style={{float:"right"}}>
                                    <img className={classes.profilePhoto} src="https://ranking-pro-files.s3.sa-east-1.amazonaws.com/profile-photo-undefined-ce18a295e46088bf"/>
                                    <a className="dropbtn"><img className={classes.profilePhoto} src={user.profilePhotoLink}/></a>
