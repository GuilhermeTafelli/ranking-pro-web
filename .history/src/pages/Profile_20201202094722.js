                ...
                <Grid item className={classes.profileContainer} md={3}>             
                    <Grid container className={classes.profileItem}>
                        ...
                        <Grid container className={classes.socialNetworkContainer} spacing={1}>
                            <Grid item>
                                <a href="google.com"><img src={FacebookIcon}/></a>
                            </Grid>
                            <Grid item>
                            <a href="google.com"><img src={InstagramIcon}/></a>
                            </Grid>
                            <Grid item>
                            <a href="google.com"><img src={WhatsAppIcon}/></a>
                            </Grid>
                            <Grid item>
                            <a href="google.com"><img src={LinkedInIcon}/></a>
                            </Grid>
                            <Grid item>
                            <a href="google.com"><img src={TwitterIcon}/></a>
                            </Grid>
                            <Grid item>
                            <a href="google.com"><img src={TikTokIcon}/></a>
                            </Grid>
                            <Grid item>
                            <a href="google.com"><img src={YoutubeIcon}/></a>
                            </Grid>
