    ...
    <React.Fragment>
        ...
        {content && <div className={classes.main}>
            <Grid container className={classes.mainContainer} md={8}>
                ...
                <Grid item container className={classes.rankingListContainer} > 
                
                    <Grid item xs={12}><ul className={classes.rankingList}>
                {content.map((item, index) =>
                    <li>
                    <Grid container item className={classes.rankingItem}>
                        <Grid container item className={classes.itemInfos}>
                            <Grid container>
