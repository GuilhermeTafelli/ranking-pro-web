...
export default function Ranking() {
  ...
  useEffect(async () => {
    ...
    await setItems({teste: "teste", teste2: ["teste"]})
    console.log(response.data.socialsMedia[0].id)

    const newItems = response.data.socialsMedia.map(item => ({id: item.id}))
    await setContent({items: newItems})
    // console.log("enters")
                    ...
                    <Grid container item className={classes.rankingItem} xs={12}>
                        <Grid item>
                            <Grid container>
                                ...
                                <Grid item className={classes.rankingItemNameContainer}>
                                    <h3 className={classes.rankingItemName}>{item}</h3>
                        ...
                        <Grid item className={classes.rankingItemRevenuesContainer}>
                            <h4 className={classes.rankingItemTitle}>Faturamento</h4>
                            <h2 className={classes.rankingItemRevenuesText}>"{"R$ "}</h2>
                        </Grid>
                        <Grid item className={classes.sectionDesktop}>
                            <Grid container>
                                <Grid item className={classes.infosContainer}>
