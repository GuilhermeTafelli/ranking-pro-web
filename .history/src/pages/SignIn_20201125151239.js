  ...
  return (
    <React.Fragment>
          ...
          <Form className={classes.form} onSubmit={handleSubmit} >
            <Grid container className={classes.formContainer}>
              ...
              <Grid container item className={classes.forgotPasswordContainer} xs={12}>
                <a href="/reset" onClick={console.log("hello")}className={classes.forgotPassword}>Esqueceu a senha? Clique aqui</a>
              </Grid>
            </Grid>
          </Form>
        </div>
      ...
      <div className={classes.footer}>
          <a className={classes.footerText}>{"Termos & Condições"}</a>|<a>{"Políticas de Privacidade"}</a>
      </div>
    </React.Fragment>
  );
}