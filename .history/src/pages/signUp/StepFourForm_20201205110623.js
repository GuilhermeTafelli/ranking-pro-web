...
export default function StepFourForm() {
    ...
    return (
        ...
        <Form ref={formRef} className={classes.form} onKeyPress={e => { if (e.keyCode === 13) { e.stopPropagation() } }} onSubmit={handleSubmit}>
            <Grid container>
                ...
                <Grid container item className={classes.input} xs={12}>
                    ...
                    <Grid container item className={classes.inputSkillsContainer}>
                        <Grid item>
                            <input value={skill} onKeyDown={(event) => { if (event.keyCode === 13) handleSubmitSkill() }} onChange={handleSkillChange} className={classes.inputSkills} />
                        </Grid>
                        <Grid item>
