...
export default function SignUp() {
    ...
    return (
        ...
        <Grid container className={classes.main} style={{background: "red", height: "100%"}}>
          <Grid item>
            ...
            <Grid container item className={classes.grow} style={{background: "red", height: "100%"}}>a</Grid>
        </Grid>
