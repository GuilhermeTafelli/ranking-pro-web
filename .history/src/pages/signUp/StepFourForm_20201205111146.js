...
export default function StepFourForm() {
    ...
    return (
        ...
        <Form onKeyDown={handleSubmitKeyPress}  ref={formRef} className={classes.form} onSubmit={handleSubmit}>
            <Grid container>
                ...
                <Grid container item className={classes.input} xs={12}>
                    ...
                    <Grid container item className={classes.inputSkillsContainer}>
                        <Grid item>
                            <input value={skill} onKeyDown={(event) => { if (event.keyCode === 13) handleSubmitSkill(), event.stopPropagation() }} onChange={handleSkillChange} className={classes.inputSkills} />
                        </Grid>
                        <Grid item>
                ...
                <Grid container item className={classes.input} xs={12}>
                    ...
                    <Grid container item className={classes.inputSkillsContainer}>
                        <Grid item>
                            <input value={niche} onKeyDown={(event) => { if (event.keyCode === 13) handleSubmitNiche() }} onChange={handleNicheChange} className={classes.inputSkills} />
                        </Grid>
                        <Grid item>
