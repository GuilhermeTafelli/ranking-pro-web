...
export default function StepOneForm(){
    ...
    const [file, setFile] = React.useState(state.photoFile);
    ...
    return (
        ...
        <Form ref={formRef} className={classes.form} onSubmit={handleSubmit}>
            ...
            <Grid container className={classes.profilePhotoContainer}>
                ...
                <Grid item className={classes.input}>
                    <FileInput name="foto" type="file" defaultValue={file.name ? file.name : ""} onChange={handleChange} id="upload" accept="image/*" style={{display: "none"}}/>
                </Grid>
            </Grid>
