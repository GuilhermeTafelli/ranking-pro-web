            ...
            <Grid container>
                ...
                <Grid container item className={classes.input} xs={12}>
                    ...
                    <Grid container item className={classes.inputSkillsContainer}>
                        <Grid item>
                            <input value={skill} onKeyDown={(event) => { if (event.keyCode === 13){ event.stopPropagation();handleSubmitSkill()}}} onChange={handleSkillChange} className={classes.inputSkills} />
                        </Grid>
                        <Grid item>
