    ...
    return (
        <div className="main">
            <div className="mainContainer">
                ...
                <p>A sua privacidade é importante para nós. É política do  respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://plataforma3ls.com.br"></a>, e outros sites que possuímos e operamos.</p>
                ...
                <ul>
                    ...
                    <li>B) Não divulgar conteúdo ou propaganda de natureza racista, xenofóbica, <a href='https://ondeapostar.pt/' style={{ color: "inherit", fontWeight: "normal", textDecoration: "none" }}>casas de apostas</a>, pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
